$(function(){
    ...
    jQuery('<div class="quantity-nav"><div class="quantity-button quantity-up"><img src="img/plus.png" alt=""></div><div class="quantity-button quantity-down"><img src="img/minus.png" alt=""></div></div>').insertAfter('.quantity input');
